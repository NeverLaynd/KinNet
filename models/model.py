...
from models.mixer_KAN import MixerModel1
...
class FASTAModel_Smiles(nn.Module):
    def __init__(self, char_set_len):
        super().__init__()
        self.mam = MixerModel1(d_model=166,n_layer=1,vocab_size=char_set_len,rms_norm=True,d_intermediate=16)
...
class Classifier(nn.Sequential):
    ...
    def __init__(self, smiles_model, fasta_model, mol_model,device):
    ...
    def forward(self, smiles, fasta,cg):
        ...
        v_smiles, ve_smiles= self.smiles_model(smiles)
